...
describe('micro-tpl', function () {
  it('should able to build a template have a variable "it"', function () {
    var foo = (0, _.build)(_fs2.default.readFileSync(_path2.default.join(__dirname, './tpl/it.html'), { encoding: 'utf8' }));
    call(foo, { say: 'Hello, world!' }).should.equal('<p>Hello, world!</p>');
  });

  it('should able to build a template have a variable "say"', function () {
    var foo = (0, _.build)(_fs2.default.readFileSync(_path2.default.join(__dirname, './tpl/render.html'), { encoding: 'utf8' }));
    call(foo, { say: 'Hello, world!' }).should.equal('<p>Hello, world!</p>');
  });

  it('should able to use loop', function () {
    var foo = (0, _.build)(_fs2.default.readFileSync(_path2.default.join(__dirname, './tpl/loop.html'), { encoding: 'utf8' }));
  ...
  it('should able to include other template', function () {
    var p = _path2.default.join(__dirname, './tpl/include.html'),
        foo = (0, _.build)(_fs2.default.readFileSync(p, { encoding: 'utf8' }), { path: p });
  ...
  it('should throw a error if trying circular reference', function () {
    ...
    _.build.bind(null, _fs2.default.readFileSync(p, { encoding: 'utf8' }), { path: p }).should.throw(/circular reference/);
  });

  it('should able to build a template have a variable "it" strict mode', function () {
    var foo = (0, _.build)(_fs2.default.readFileSync(_path2.default.join(__dirname, './tpl/it.html'), { encoding: 'utf8' }), { strict: true });
    call(foo, { say: 'Hello, world!' }).should.equal('<p>Hello, world!</p>');
  });

  it('should not able to build a template have a variable "say" strict mode', function () {
    var foo = (0, _.build)(_fs2.default.readFileSync(_path2.default.join(__dirname, './tpl/render.html'), { encoding: 'utf8' }), { strict: true });
  ...
  it('should throw a error when render a bad template in safe mod', function () {
    var file = _path2.default.join(__dirname, './bad/noclose.html'),
        foo = _.build.bind(null, _fs2.default.readFileSync(file, { encoding: 'utf8' }), { safe: true, path: file }).should.throw();
  });
  ...
  it('should throw a error when finding unexpected token', function () {
    ...
    _.build.bind(null, _fs2.default.readFileSync(file1, { encoding: 'utf8' }), { safe: true, path: file1 }).should.throw();

    _.build.bind(null, _fs2.default.readFileSync(file2, { encoding: 'utf8' }), { safe: true, path: file2 }).should.throw();
  });

  it('should able to build just function content', function () {
    var foo = (0, _.build)(_fs2.default.readFileSync(_path2.default.join(__dirname, './tpl/it.html'), { encoding: 'utf8' }), { strict: true, ret: 'function' });
  });
